# -*- coding: utf-8 -*-
"""Copy of TARP_FINALMODEL.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DlC1OXCHfUJTH6uIaIfXzr1aCJiOWf5o
"""
...
for idx, cls in enumerate(categories):
    ...
    cls_values = [cls_data[metric] for metric in metrics]
    plt.plot(metrics, cls_values, marker='o', label=cls)

plt.title("Test Dataset Per-Class Performance Metrics")
plt.ylim(0, 1)
plt.ylabel("Score")
plt.grid(True)
plt.legend()
